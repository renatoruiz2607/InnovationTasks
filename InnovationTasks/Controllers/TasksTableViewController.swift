...
//  InnovationTasks
//
//  Created by Roberto Ruiz Cai on 29/06/21.
...
let tasks: [Task] = [
    ...
    Task(name: "Study math for my computer science class because it's too hard to undestand Calculus and I need to study pretty hard to understand it!", date: Date(), category: study),
]
